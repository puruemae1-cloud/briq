...
export const subcategoryGroups: Partial<Record<SubcategoryId, SubcategoryId[]>> = {
  ...
  "al-men-rtw-all": ["al-men-rtw-all", ...AL_MEN_RTW_LEAF_IDS],
  ...
  "al-women-rtw-all": ["al-women-rtw-all", ...AL_WOMEN_RTW_LEAF_IDS],
  ...
  "al-men-shoes-all": ["al-men-shoes-all", ...AL_MEN_SHOES_LEAF_IDS],
  "al-men-boots": ["al-men-boots"],
  "al-men-casual-shoes": ["al-men-casual-shoes"],
  "al-men-trainers": ["al-men-trainers"],
  "al-women-shoes-all": ["al-women-shoes-all", ...AL_WOMEN_SHOES_LEAF_IDS],
  ...
  "al-men-acc-all": ["al-men-acc-all", ...AL_MEN_ACC_LEAF_IDS],
  ...
  "al-women-acc-all": ["al-women-acc-all", ...AL_WOMEN_ACC_LEAF_IDS],
  ...
  // "전체" must match the parent hub (same as di-women-shoes-all), not a singleton tag.
  "di-women-rtw-all": ["di-womens", ...DI_WOMEN_RTW_LEAF_IDS],
  ...
  "di-men-rtw-all": ["di-mens", ...DI_MEN_RTW_LEAF_IDS],
  ...
  "di-men-slg-all": ["di-men-slg", ...DI_MEN_SLG_LEAF_IDS],
  "di-women-accessories": [
    "di-women-accessories",
    ...DI_WOMEN_ACCESSORIES_LEAF_IDS,
    "di-women-jewelry",
  ...
  "di-women-jewelry-all": ["di-women-jewelry", ...DI_WOMEN_JEWELRY_LEAF_IDS],
  ...
  "di-women-slg-all": ["di-women-slg", ...DI_WOMEN_SLG_LEAF_IDS],
