#!/usr/bin/env python3
"""Enrich Dior men's SLG catalog: rich PDP copy, featuresKo, techSpecs.

One Size only — no size charts. Checkpoints every 25 SKUs.

  python3 scripts/enrich-di-men-slg-pdp.py
  python3 scripts/enrich-di-men-slg-pdp.py --only 2ESCH135FGP_H140
"""
...
RAW = ROOT / "src/data/di/di-men-slg-catalog-raw.json"
CHECKPOINT_EVERY = 25
