...
DI_WOMEN_SHOES = {
    "id": "di-women-shoes",
    "titleKo": "디올 여성 슈즈 사이즈 가이드",
    "noteKo": (
        "dior.com(영국) 공식 Size Chart입니다. "
        "Briq 사이즈 선택란의 숫자(37·38.5 등)는 아래 Dior Size (IT/EU/FR) 열과 "
        "대응합니다. UK·US-AU·KR(mm)·JP·CN은 공식 환산값이며, 모델·라스트에 따라 "
        "핏이 다를 수 있으니 참고용으로 확인해 주세요."
    ),
    "headers": ["Dior Size (IT/EU/FR)", "UK", "US-AU", "KR (mm)", "JP", "CN"],
    "rows": [
        ["34", "1.5", "4", "210", "21", "34.5"],
        ["34.5", "2", "4.5", "215", "21.5", "35"],
        ["35", "2.5", "5", "220", "22", "35.5"],
        ["35.5", "3", "5.5", "225", "22.5", "36"],
        ["36", "3.5", "6", "230", "23", "36.5"],
        ["36.5", "4", "6.5", "235", "23.5", "37"],
        ["37", "4.5", "7", "240", "24", "37.5"],
        ["37.5", "5", "7.5", "245", "24.5", "38"],
        ["38", "5.5", "8", "250", "25", "38.5"],
        ["38.5", "6", "8.5", "255", "25.5", "39"],
        ["39", "6.5", "9", "260", "26", "39.5"],
        ["39.5", "7", "9.5", "265", "26.5", "40"],
        ["40", "7.5", "10", "270", "27", "40.5"],
        ["40.5", "8", "10.5", "275", "27.5", "41"],
        ["41", "8.5", "11", "280", "28", "41.5"],
        ["41.5", "9", "11.5", "285", "28.5", "42"],
        ["42", "9.5", "12", "290", "29", "42.5"],
        ["42.5", "10", "12.5", "295", "29.5", "43"],
    ],
}


def size_chart_for_di_womens_shoes() -> dict:
    return copy.deepcopy(DI_WOMEN_SHOES)
