#!/usr/bin/env python3
"""Enrich Dior men's accessories catalog: rich PDP copy, featuresKo, techSpecs.

One Size only — no size charts. Checkpoints every 25 SKUs.

  python3 scripts/enrich-di-men-accessories-pdp.py
  python3 scripts/enrich-di-men-accessories-pdp.py --only 2ESCH135FGP_H140
"""
...
from di_common import MEN_ACCESSORIES_LEAVES, algolia_merch_hits_by_codes  # noqa: E402
...
RAW = ROOT / "src/data/di/di-men-accessories-catalog-raw.json"
CHECKPOINT_EVERY = 25

ACC_LEAVES = {
    "di-men-accessories",
    *[L["id"] for L in MEN_ACCESSORIES_LEAVES],
}
