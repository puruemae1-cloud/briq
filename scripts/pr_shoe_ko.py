...
TITLE_KO: dict[str, str] = {
    ...
    "Vintage-effect leather boots": "빈티지 이펙트 가죽 부츠",    "Aged suede loafers": "에이징 스웨이드 로퍼",
    "Antiqued leather loafers": "앤틱 가죽 로퍼",
    "Brixxen leather booties": "Brixxen 가죽 부티",
    "Brushed leather Chelsea boots": "브러시드 가죽 첼시 부츠",
    "Brushed leather derby shoes": "브러시드 가죽 더비 슈즈",
    "Brushed leather flip-flops": "브러시드 가죽 플립플롭",
    "Brushed leather lace-up shoes": "브러시드 가죽 레이스업 슈즈",
    "Brushed leather laced shoes": "브러시드 가죽 레이스 슈즈",
    "Chocolate aged leather loafers": "초콜릿 에이징 가죽 로퍼",
    "Collapse Re-Nylon and suede elasticized sneakers": "Collapse Re-Nylon & 스웨이드 엘라스틱 스니커즈",
    "Collapse antiqued nappa leather sneakers with hooks": "Collapse 앤틱 나파 가죽 훅 스니커즈",
    "Collapse canvas sneakers": "Collapse 캔버스 스니커즈",
    "Collapse leather sneakers": "Collapse 가죽 스니커즈",
    "Crisscross leather sandals": "크리스크로스 가죽 샌들",
    "Crisscross rubber slides": "크리스크로스 러버 슬라이드",
    "Crisscross slides": "크리스크로스 슬라이드",
    "Downtown Re-Nylon and suede sneakers": "Downtown Re-Nylon & 스웨이드 스니커즈",
    "Downtown leather sneakers": "Downtown 가죽 스니커즈",
    "Downtown nappa leather sneakers": "Downtown 나파 가죽 스니커즈",
    "Fabric loafers": "패브릭 로퍼",
    "High-top Re-Nylon sneakers": "하이탑 Re-Nylon 스니커즈",
    "Laced leather booties": "레이스 가죽 부티",
    "Laced leather loafers": "레이스 가죽 로퍼",
    "Leather Chelsea boots": "가죽 첼시 부츠",
    "Leather crisscross slides": "가죽 크리스크로스 슬라이드",
    "Leather mid-calf boots": "가죽 미드카프 부츠",
    "Leather sneakers": "가죽 스니커즈",
    "Leather strap slides": "가죽 스트랩 슬라이드",
    "Leather zipper boots": "가죽 지퍼 부츠",
    "Monolith brushed leather loafers": "모놀리스 브러시드 가죽 로퍼",
    "Patent leather and technical fabric Prada America's Cup sneakers": "페이턴트 가죽 & 테크니컬 패브릭 프라다 아메리카스 컵 스니커즈",
    "Prada America's Cup Soft rubber and bike fabric sneakers": "프라다 아메리카스 컵 Soft 러버 & 바이크 패브릭 스니커즈",
    "Prada America's Cup metallic leather and bike fabric sneakers": "프라다 아메리카스 컵 메탈릭 가죽 & 바이크 패브릭 스니커즈",
    "Prada America’s Cup Original sneakers": "프라다 아메리카스 컵 Original 스니커즈",
    "Prada Made in India x Inspired by Kolhapuri Chappal leather sandals": "프라다 Made in India x Kolhapuri Chappal 가죽 샌들",
    "Prax 01 Re-Nylon and brushed leather sneakers": "Prax 01 Re-Nylon & 브러시드 가죽 스니커즈",
    "Prax 2.0 Re-Nylon and leather sneakers": "Prax 2.0 Re-Nylon & 가죽 스니커즈",
    "Prax 2.0 Re-Nylon and suede sneakers": "Prax 2.0 Re-Nylon & 스웨이드 스니커즈",
    "Prax 2.0 fabric sneakers": "Prax 2.0 패브릭 스니커즈",
    "Prax 2.0 leather sneakers": "Prax 2.0 가죽 스니커즈",
    "Prax leather and fabric sneakers": "Prax 가죽 & 패브릭 스니커즈",
    "Prax leather sneakers": "Prax 가죽 스니커즈",
    "Prax mesh fabric and leather loafers": "Prax 메쉬 패브릭 & 가죽 로퍼",
    "Prax suede and Re-Nylon sneakers": "Prax 스웨이드 & Re-Nylon 스니커즈",
    "Rubber fisherman sandals": "러버 피셔맨 샌들",
    "Rubber strap sandals": "러버 스트랩 샌들",
    "Saffiano leather crisscross slides": "사피아노 가죽 크리스크로스 슬라이드",
    "Shuffle aged canvas and leather boat shoes": "Shuffle 에이징 캔버스 & 가죽 보트 슈즈",
    "Shuffle antiqued leather laced shoes": "Shuffle 앤틱 가죽 레이스 슈즈",
    "Speedrock Re-Nylon and suede sneakers": "Speedrock Re-Nylon & 스웨이드 스니커즈",
    "Speedrock leather and mesh fabric sneakers": "Speedrock 가죽 & 메쉬 패브릭 스니커즈",
    "Speedrock leather loafers": "Speedrock 가죽 로퍼",
    "Suede and woven tape sporty sandal": "스웨이드 & 우븐 테이프 스포티 샌들",
    "Suede band sandals": "스웨이드 밴드 샌들",
    "Suede boat shoes with laces": "스웨이드 레이스 보트 슈즈",
    "Toblach laced leather shoes": "Toblach 레이스 가죽 슈즈",
    "Toblach leather loafers": "Toblach 가죽 로퍼",
    "Waxed suede lace-up shoes": "왁스드 스웨이드 레이스업 슈즈",
...
COLOR_KO: dict[str, str] = {
    ...
    "White/Black": "화이트/블랙",
    "White/Blue": "화이트/블루",
    "Anthracite Gray/Silver": "앤트래사이트 그레이/실버",
    "Anthracite/Ink": "앤트래사이트/잉크",
    "Aviation Blue": "애비에이션 블루",
    "Baltic Blue": "발틱 블루",
    "Billiard Green": "빌리어드 그린",
    "Blue": "블루",
    "Brandy": "브랜디",
    "Brass/Burgundy": "브라스/버건디",
    "Burnt Brown": "번트 브라운",
    "Cinnamon": "시나몬",
    "Cloudy Gray": "클라우드 그레이",
    "Coral": "코럴",
    "Cream": "크림",
    "Denim": "데님",
    "Desert": "데저트",
    "Desert/Ivory": "데저트/아이보리",
    "Dew/Sage": "듀/세이지",
    "Ebony": "에보니",
    "Gravel Gray": "그래블 그레이",
    "Green / Silver": "그린/실버",
    ...
    "Pearl / Silver": "펄/실버",
    "Raw White": "로 화이트",
    "Red/Anthracite": "레드/앤트래사이트",
    "Red/Silver": "레드/실버",
    "Rosewood/Ebony": "로즈우드/에보니",
    "Royal Blue": "로열 블루",
    "Royal Blue/Silver": "로열 블루/실버",
    "Sapphire/Anthracite": "사파이어/앤트래사이트",
    "Selva Green": "셀바 그린",
    "Sienna": "시에나",
    "Steel Gray": "스틸 그레이",
    "Tobacco": "토바코",
    "Ultramarine": "울트라마린",
    "Violet/Silver": "바이올렛/실버",
...
def apply_phrases(text: str) -> str:
    ...
    out = re.sub(r"\bcovered\b", "커버", out, flags=re.I)
    out = re.sub(r"\bnarrow\b", "슬림", out, flags=re.I)
    out = re.sub(r"\bhook\b", "훅", out, flags=re.I)
