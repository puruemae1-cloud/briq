...
def main() -> None:
    ...
    OUT_TS.write_text(
        ...
        f"export const ceCatalogProducts = {json.dumps(products, ensure_ascii=False)} as Product[];\n"
        f"export const ceCatalogGeneratedAt = {json.dumps(datetime.now(timezone.utc).isoformat())};\n"
    )
