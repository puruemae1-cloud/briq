...
# Official CELINE GB Product-SizeGuide D04 / D07 — all country columns
# (JP = foot length cm, KR = mm), matching PDP size-guide HTML.
CE_SHOES_WOMEN_ROWS = [
    ["34", "34.5", "1", "4", "21", "34.5", "210"],
    ["34.5", "35", "1.5", "4.5", "21.5", "35", "215"],
    ["35", "35.5", "2", "5", "22", "35.5", "220"],
    ["35.5", "36", "2.5", "5.5", "22.5", "36", "225"],
    ["36", "36.5", "3", "6", "23", "36.5", "230"],
    ["36.5", "37", "3.5", "6.5", "23.5", "37", "235"],
    ["37", "37.5", "4", "7", "24", "37.5", "240"],
    ["37.5", "38", "4.5", "7.5", "24.5", "38", "245"],
    ["38", "38.5", "5", "8", "25", "38.5", "250"],
    ["38.5", "39", "5.5", "8.5", "25.5", "39", "255"],
    ["39", "39.5", "6", "9", "26", "39.5", "260"],
    ["39.5", "40", "6.5", "9.5", "26.5", "40", "265"],
    ["40", "40.5", "7", "10", "27", "40.5", "270"],
    ["40.5", "41", "7.5", "10.5", "27.5", "41", "275"],
    ["41", "41.5", "8", "11", "28", "41.5", "280"],
    ["41.5", "42", "8.5", "11.5", "28.5", "42", "285"],
    ["42", "42.5", "9", "12", "29", "42.5", "290"],
    ["42.5", "43", "9.5", "12.5", "29.5", "43", "295"],
]

CE_SHOES_MEN_ROWS = [
    ["39", "40", "6", "7", "25", "40", "240"],
    ["39.5", "40.5", "6.5", "7.5", "25.5", "40.5", "245"],
    ["40", "41", "7", "8", "26", "41", "250"],
    ["40.5", "41.5", "7.5", "8.5", "26.5", "41.5", "255"],
    ["41", "42", "8", "9", "27", "42", "260"],
    ["41.5", "42.5", "8.5", "9.5", "27.5", "42.5", "265"],
    ["42", "43", "9", "10", "28", "43", "270"],
    ["42.5", "43.5", "9.5", "10.5", "28.5", "43.5", "275"],
    ["43", "44", "10", "11", "29", "44", "280"],
    ["43.5", "44.5", "10.5", "11.5", "29.5", "44.5", "285"],
    ["44", "45", "11", "12", "30", "45", "290"],
    ["44.5", "45.5", "11.5", "12.5", "30.5", "45.5", "295"],
    ["45", "46", "12", "13", "31", "46", "300"],
]
...
def ce_shoes_size_chart(*, men: bool) -> dict:
    ...
    return {
        ...
        "noteKo": "셀린느 공식 사이즈 가이드 기준입니다. JP는 발길이(cm), KR은 mm입니다.",
