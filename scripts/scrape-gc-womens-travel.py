#!/usr/bin/env python3
"""Scrape Gucci UK women's travel bags + PDP images.

Mirrors scrape-gc-womens-wallets.py: productgrid leaves + catalog API + DarkGray
images into public/products/gc-pdp/. Writes gc-travel-catalog-raw.json.

Official PLP:
https://www.gucci.com/uk/en_gb/ca/women/travel-bags-for-women-c-women-accessories-lifestyle-bags-and-luggage
"""
...
OUT_RAW = ROOT / "src/data/gc/gc-travel-catalog-raw.json"
...
WARM_URL = (
    ...
    "travel-bags-for-women-c-women-accessories-lifestyle-bags-and-luggage"
)

# Official travel leaves → Briq collection ids
# categoryCode is the URL segment after -c-
COLLECTIONS: list[tuple[str, str, str]] = [
    ("gc-women-trolley", "Trolley", "women-travel-trolley"),
    (
        "gc-women-weekend-duffle",
        "Weekend bags & Duffle bags",
        "women-carry-ons-duffle-bags",
    ),
    (
        "gc-women-travel-accessories",
        "Accessories",
        "women-accessories-luggage-lifestyle-bags-travel-accessories",
    ),
    (
        "gc-women-hard-shell-luggage",
        "Hard Shell Luggage",
        "women-hard-sided-luggage",
    ),
]

ALL_TRAVEL_CODE = "women-accessories-lifestyle-bags-and-luggage"
PARENT_COLL = "gc-women-travel"
PARENT_COLLS = (
    "gc-women-travel",
    "gucci-accessories",
)
